...
My go to is docker, so that's what I'll be referencing in this workshop.
...
If you want to learn more about docker, there is a easy tro follow guide on their website. See [Docker](https://docs.docker.com/get-started/)
...
If you're using Visual Studio Code, it's easy to use dev containers in your project right now. There is an extension that you can install, and then you can use the `.devcontainer.json` file to define how the container should be built.
